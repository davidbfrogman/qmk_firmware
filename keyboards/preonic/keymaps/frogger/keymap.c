 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |  Gui | Alt  |Backli|Lower |    Space    |Raise |   (  |   {  |   }  |   )  |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_preonic_grid( \
  ...
  KC_LCTL,  KC_LGUI, KC_LALT, KC_E, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LPRN, KC_LCBR, KC_RCBR, KC_RPRN  \
),
...
[_LOWER] = LAYOUT_preonic_grid( \
  ...
  _______, _______, _______,  _______,  _______,  _______,  _______,   _______,        KC_UP,    KC_LCBR,        KC_RCBR,  _______, \
...
[_RAISE] = LAYOUT_preonic_grid( \
  ...
  _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_MINS,  KC_EQL,  KC_LCBR, KC_RCBR, KC_BSLS, \
